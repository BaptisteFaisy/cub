...
/*   Updated: 2024/08/28 18:31:49 by lhojoon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	checkligne(char **tab, int ligne, int *para, t_tab *liste)
{
	...
	i = 0;
	if (((tab[ligne][0] == 'N' && tab[ligne][1] == 'O' && tab[ligne][2] != ' ' )
		|| (tab[ligne][0] == 'N' && tab[ligne][1] == 'O' && para[0] == 1)))
		return (0);
	if ((tab[ligne][0] == 'N' && tab[ligne][1] == 'O' && para[0] == 0))
		return (para[0] = 1, checklignev2(tab, ligne, i, liste));
	if ((tab[ligne][0] == 'S' && tab[ligne][1] == 'O' && tab[ligne][2] != ' ')
		|| (tab[ligne][0] == 'S' && tab[ligne][1] == 'O' && para[1] == 1))
		return (0);
	if ((tab[ligne][0] == 'S' || tab[ligne][1] == 'O') && para[1] == 0)
		return (para[1] = 1, checklignev2(tab, ligne, i, liste));
	if ((tab[ligne][0] == 'W' && tab[ligne][1] == 'E' && tab[ligne][2] != ' ')
		|| (tab[ligne][0] == 'W' && tab[ligne][1] == 'E' && para[2] == 1))
		return (0);
	if ((tab[ligne][0] == 'W' || tab[ligne][1] == 'E') && para[2] == 0)
		return (para[2] = 1, checklignev2(tab, ligne, i, liste));
	if ((tab[ligne][0] == 'E' && tab[ligne][1] == 'A' && tab[ligne][2] != ' ')
		|| (tab[ligne][0] == 'E' && tab[ligne][1] == 'A' && para[3] == 1))
		return (0);
